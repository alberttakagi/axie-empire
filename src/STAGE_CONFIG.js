...
export const STAGE_CONFIG = [
  ...
  // ⚠ KNOWN GAP (see docs/BATTLE_CATS_MAPPING.md's roadmap): saga2/saga3
  // below (stage11-30) were NOT rebalanced in this pass — they still assume
  // the OLD, much smaller ENEMY_CONFIG.js stat scale (e.g. old titan hp 260
  // vs the new real Emperor Nyandam's 99999). Every enemyId reference below
  // still resolves (no crash), but every statMultiplier here is now wildly
  // miscalibrated against what that enemyId actually spawns — these 20
  // stages need the same real-stat rebalancing pass saga1 just got before
  // they're playable at their intended difficulty. This pass's scope was
  // explicitly "Chapter 1 core roster" only (see the user's own scoping
  // answer) — treat saga2/saga3 as a known follow-up, not a bug.
  {
    id: 'stage11',
    saga: 'saga2',
